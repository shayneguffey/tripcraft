...
const STATUS_OPTIONS = [
  { key: "planning", label: "Planning", activeBg: "rgba(120,113,108,0.5)", hoverBg: "rgba(120,113,108,0.3)" },
  { key: "traveled", label: "Traveled", activeBg: "rgba(100,116,139,0.5)", hoverBg: "rgba(100,116,139,0.3)" },
  { key: "wish", label: "Wish", activeBg: "rgba(251,113,133,0.4)", hoverBg: "rgba(251,113,133,0.25)" },
];
...
function StatusPill({ label, isActive, activeBg, hoverBg, onClick }) {
  ...
  const bg = isActive ? activeBg : pillHover ? hoverBg : "rgba(255,255,255,0.1)";
  const color = isActive || pillHover ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.5)";
  const ring = isActive ? "1px solid rgba(255,255,255,0.25)" : "none";
  ...
  return (
    <button
      ...
      className="w-[4.2rem] py-[3px] rounded-full text-[9px] font-semibold text-center backdrop-blur-sm"
      style={{
        background: bg,
        color: color,
        outline: ring,
    ...
    >
      ...
      <Link href={`/trips/${trip.id}`} className="block">
        <div className="relative rounded-2xl overflow-hidden aspect-[3/4] flex flex-col justify-end shadow-sm hover:shadow-xl transition-all duration-300">
          {/* Background with cohesive photo filter */}
          {hasImage ? (
            <div
              ...
              style={{
                ...
                filter: hovered
                  ? "sepia(0.15) saturate(0.9) contrast(0.97) brightness(1.03) hue-rotate(-2deg)"
                  : "sepia(0.3) saturate(0.82) contrast(0.94) brightness(1.0) hue-rotate(-4deg)",
          ...
          <div className="relative z-10 p-4 pr-[5.5rem]">
            <InlineEdit
              ...
              className="text-white/70 text-xs block mb-0.5"
              placeholder="Add destination"
            />
            <InlineEdit
              value={trip.title}
              onSave={(v) => onFieldUpdate(trip.id, "title", v)}
              className="font-bold text-white text-base leading-tight block mb-0.5"
    ...
    <div className="min-h-screen relative">
      ...
      <div
        ...
        style={{
          ...
          filter: "sepia(0.15) saturate(0.4) brightness(1.1)",
          opacity: 0.5,
        }}
      />
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/dashboard"
            className="w-8 h-8 rounded-lg bg-stone-800/20 text-stone-700 flex items-center justify-center backdrop-blur-sm hover:bg-stone-800/30 transition-colors"
            title="Card view"
          >
          ...
          <Link
            href="/globe"
            className="w-8 h-8 rounded-lg bg-white/20 text-stone-500 flex items-center justify-center backdrop-blur-sm hover:bg-stone-800/20 hover:text-stone-700 transition-colors"
            title="Globe view"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold text-stone-800">TripCraft</span>
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="w-8 h-8 rounded-full bg-stone-800/20 text-stone-700 flex items-center justify-center backdrop-blur-sm hover:bg-stone-800/30 transition-colors"
            title="Account"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
