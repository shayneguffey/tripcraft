    ...
    <div className="mb-4">
      ...
      {options.length === 0 && !showModal && (
        <div className="bg-white rounded-xl border border-orange-100 shadow-sm p-8 text-center">
          <svg className="w-10 h-10 text-orange-300 mx-auto mb-3" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-orange-100 w-full max-w-lg max-h-[85vh] overflow-y-auto"
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-slate-400 mb-2">Paste a Yelp, OpenTable, Google Maps, or restaurant URL. Or paste / drop a screenshot.</p>
            {!screenshot ? (
              <div
                ...
                className={`border-2 border-dashed rounded-lg transition-colors ${
                  dragOver ? "border-rose-400 bg-rose-50" : "border-slate-300"
                }`}
              >
                <textarea
                  value={pasteInput}
                  ...
                  rows={2}
                  autoFocus
                  placeholder={`https://www.opentable.com/... — or paste an image`}
            ...
            {urlStatus === "done" && aiResult?.name && (
              <div className="mt-2 px-3 py-2 bg-rose-50 rounded-lg text-xs text-rose-700">
                Found: {aiResult.name}
              </div>
            )}
